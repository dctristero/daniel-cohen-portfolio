// re-deploy ontheshelf to github pages
// on resume page make bottom box into button with hover properties affecting all text in button
// make sure resume links to correct file
// on contact page make the links only look different on hover
// pick better theme color for hovered text -- dusky, greyish lavender
